...
func ArgsInit() *InputArgs {
	...
	NewIp := flag.String("ja", "localhost", "The Chord client ip that will join this node’s ring")
	NewPort := flag.Int("jp", 1234, "The Chord client port that will join this node’s ring")
